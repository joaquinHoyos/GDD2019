...
CREATE TABLE Compra(comp_id int IDENTITY(1,1) NOT NULL,comp_oferta nvchar(50) NOT NULL, comp_cliente int NOT NULL, comp_cantidad int,comp_factura Numeric(18,0), comp_importe int);
