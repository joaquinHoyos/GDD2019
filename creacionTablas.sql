...
CREATE TABLE PASO_A_PASO.Credito (cred_id int IDENTITY(1,1) NOT NULL, cred_cliente int, cred_tipoPago varchar(30), cred_fecha smalldatetime,  cred_tarjeta Numeric(10) , cred_monto Numeric(10));
...
CREATE TABLE PASO_A_PASO.TipoPago(tipoPago_id Numeric(10,1) NOT NULL, tipo_descripcion varchar(30));