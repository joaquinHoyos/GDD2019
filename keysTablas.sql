...
ALTER TABLE PASO_A_PASO.Cupon ADD CONSTRAINT FK_Cupon_Oferta FOREIGN KEY (cupo_oferta) REFERENCES PASO_A_PASO.Oferta(ofer_id,ofer_proveedor);
...
ALTER TABLE PASO_A_PASO.Compra ADD CONSTRAINT FK_Compra_Oferta FOREIGN KEY (comp_oferta) REFERENCES PASO_A_PASO.Oferta(ofer_id,ofer_proveedor);
